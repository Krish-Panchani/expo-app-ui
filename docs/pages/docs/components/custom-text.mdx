---
title: Custom Text Component – Expo App UI
description: A customizable Text component with font, color, and spacing props for Expo React Native. Learn how to use CustomText with examples and API documentation.
---

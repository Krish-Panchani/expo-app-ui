...
interface CustomOtpInputProps {
  ...
  isError?: boolean;
  value?: string;
  /** Applied to each digit cell wrapper. */
...
const CustomOtpInput: React.FC<CustomOtpInputProps> = ({
  ...
  focusColor = "#0a0a0a",
  blurColor = "#E0E0E0",
  successBorderColor = "#525252",
  errorBorderColor = "#262626",
  ...
  useEffect(() => {
    ...
    if (isSuccess) {
      setStatusColor(successBorderColor);
    } else if (isError) {
      setStatusColor(errorBorderColor);
  ...
  }, [isSuccess, isError, successBorderColor, errorBorderColor]);
  ...
  const getBorderColor = (index: number) => {
    ...
    if (isLoading) return loadingBorderColor;
